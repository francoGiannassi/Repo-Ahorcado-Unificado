...
export default defineComponent({
  ...
  async mounted() {
    await fetch(process.env.VUE_APP_API_URL + "initPlayers", {
      method: "GET",
      headers: new Headers({
  ...
  methods: {
    ...
    async verificar() {
      ...
      const response = await fetch(
        process.env.VUE_APP_API_URL + "juego/" +
    ...
    async pedirPista() {
      const response = await fetch(process.env.VUE_APP_API_URL + "darPista", {
        method: "GET",
        headers: new Headers({
          "Content-Type": "application/json",
          "Access-Control-Allow-Origin": "*",
    ...
    async calcularResultado() {
      const response = await fetch(process.env.VUE_APP_API_URL + "resultado", {
        method: "GET",
        headers: new Headers({
          "Content-Type": "application/json",
          "Access-Control-Allow-Origin": "*",
    ...
    async getTop10() {
      const response = await fetch(process.env.VUE_APP_API_URL + "top10", {
        method: "GET",
        headers: new Headers({
          "Content-Type": "application/json",
          "Access-Control-Allow-Origin": "*",
    ...
    async retry() {
      await fetch(process.env.VUE_APP_API_URL + "retryGame", {
        method: "GET",
        headers: new Headers({
          "Content-Type": "application/json",
          "Access-Control-Allow-Origin": "*",
    ...
    async cerrarSesion() {
      await fetch(process.env.VUE_APP_API_URL + "clearAll", {
        method: "GET",
        headers: new Headers({
          "Content-Type": "application/json",
          "Access-Control-Allow-Origin": "*",
